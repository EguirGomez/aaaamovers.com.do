...
$('.js-btn-open-modal').click(function () {
	$('.modal1').addClass('fadeIn').css('display', 'block');
...
$('.js-btn-close-modal').click(function () {
	...
	setTimeout(function () {
		$('.modal').removeAttr('style').removeClass('fadeOut');
...
// modal
$('.js-btn-open-modal').click(function () {
	$('.modal2').addClass('fadeIn').css('display', 'block');
	$('body').addClass('modal-open');
	$('<div class="modal-backdrop"></div>').appendTo("body");
})
...
// modal
$('.js-btn-open-modal').click(function () {
	$('.modal3').addClass('fadeIn').css('display', 'block');
	$('body').addClass('modal-open');
	$('<div class="modal-backdrop"></div>').appendTo("body");
})
...
// modal
$('.js-btn-open-modal').click(function () {
	$('.modal4').addClass('fadeIn').css('display', 'block');
	$('body').addClass('modal-open');
	$('<div class="modal-backdrop"></div>').appendTo("body");
})
...
// modal
$('.js-btn-open-modal').click(function () {
	$('.modal5').addClass('fadeIn').css('display', 'block');
	$('body').addClass('modal-open');
	$('<div class="modal-backdrop"></div>').appendTo("body");
})
